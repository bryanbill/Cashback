...
public class OfferModel implements Serializable {
    ...
    public Integer getPromotionClaimLimit() {
        return promotionClaimLimit;
    }
    ...
    public Integer getProductCashBack() {
    ...
    public void setPromotionDetailsRetailerCommission(Double promotionDetailsRetailerCommission) {
        this.promotionDetailsRetailerCommission = promotionDetailsRetailerCommission;
    }
    ...
    public void setPromotionDetailsHotDealsIndicator(String promotionDetailsHotDealsIndicator) {
    ...
    public String toString() {
        ...
        sb.append(OfferModel.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("promotionDetailsId");
        sb.append('=');
        sb.append(((this.promotionDetailsId == null) ? "<null>" : this.promotionDetailsId));
        sb.append(',');
        ...
        sb.append('=');
        sb.append(((this.promotionDescription == null) ? "<null>" : this.promotionDescription));
        sb.append(',');
        sb.append("promotionStatus");
        sb.append('=');
        sb.append(((this.promotionStatus == null) ? "<null>" : this.promotionStatus));
        sb.append(',');
        sb.append("promotionClaimLimit");
        sb.append('=');
        sb.append(((this.promotionClaimLimit == null) ? "<null>" : this.promotionClaimLimit));
        sb.append(',');
        sb.append("productCashBack");
        sb.append('=');
        sb.append(((this.productCashBack == null) ? "<null>" : this.productCashBack));
        sb.append(',');
        sb.append("promotionDetailsRanking");
        sb.append('=');
        sb.append(((this.promotionDetailsRanking == null) ? "<null>" : this.promotionDetailsRanking));
        sb.append(',');
        ...
        sb.append('=');
        sb.append(((this.promotionDetailsRetailerCommission == null) ? "<null>" : this.promotionDetailsRetailerCommission));
        sb.append(',');
        sb.append("promotionDetailsHotDealsIndicator");
        sb.append('=');
        sb.append(((this.promotionDetailsHotDealsIndicator == null) ? "<null>" : this.promotionDetailsHotDealsIndicator));
        sb.append(',');
    ...
    public int hashCode() {
        int result = 1;
        result = ((result * 31) + ((this.promotionDetailsRanking == null) ? 0 : this.promotionDetailsRanking.hashCode()));
        result = ((result * 31) + ((this.offerStartDate == null) ? 0 : this.offerStartDate.hashCode()));
        result = ((result * 31) + ((this.promotionDetailsId == null) ? 0 : this.promotionDetailsId.hashCode()));
        result = ((result * 31) + ((this.promotionDetailsHotDealsIndicator == null) ? 0 : this.promotionDetailsHotDealsIndicator.hashCode()));
        ...
        result = ((result * 31) + ((this.promotionClaimLimit == null) ? 0 : this.promotionClaimLimit.hashCode()));
        ...
        result = ((result * 31) + ((this.promotionStatus == null) ? 0 : this.promotionStatus.hashCode()));
        result = ((result * 31) + ((this.productCashBack == null) ? 0 : this.productCashBack.hashCode()));
        result = ((result * 31) + ((this.promotionDescription == null) ? 0 : this.promotionDescription.hashCode()));
        result = ((result * 31) + ((this.productImage == null) ? 0 : this.productImage.hashCode()));
        result = ((result * 31) + ((this.productBarcode == null) ? 0 : this.productBarcode.hashCode()));
        result = ((result * 31) + ((this.offerEndDate == null) ? 0 : this.offerEndDate.hashCode()));
        result = ((result * 31) + ((this.promotionDetailsRetailerCommission == null) ? 0 : this.promotionDetailsRetailerCommission.hashCode()));
        return result;
    }
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((((((((Objects.equals(this.promotionDetailsRanking, rhs.promotionDetailsRanking))
                && (Objects.equals(this.offerStartDate, rhs.offerStartDate)))
                && (Objects.equals(this.promotionDetailsId, rhs.promotionDetailsId)))
                && (Objects.equals(this.promotionDetailsHotDealsIndicator, rhs.promotionDetailsHotDealsIndicator)))
                && (Objects.equals(this.productId, rhs.productId)))
                && (Objects.equals(this.productSize, rhs.productSize)))
                && (Objects.equals(this.promotionClaimLimit, rhs.promotionClaimLimit)))
                ...
                && (Objects.equals(this.promotionDescription, rhs.promotionDescription)))
